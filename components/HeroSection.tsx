...
export function HeroSection({ featured, secondary, articleBasePath }: HeroSectionProps) {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-site-border dark:bg-gray-700">
      ...
      <div className="bg-white dark:bg-gray-900 flex flex-col divide-y divide-site-border dark:divide-gray-700">
