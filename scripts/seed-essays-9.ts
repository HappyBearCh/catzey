...
const ESSAYS = [
  {
    ...
    content: `Tatsuki Fujimoto had published two well-regarded series before "Chainsaw Man" â€” "Fire Punch" (2016â€“2018) and several one-shots â€” but "Chainsaw Man" was the work that broke through to mainstream visibility. Serialized in Weekly Shonen Jump from December 2018, the first part concluded in December 2020 with 97 chapters; the second part began in Jump+ in July 2022 and continues. The series follows Denji, a young man living in extreme poverty who merges with his pet devil Pochita to survive, becoming a hybrid devil hunter with chainsaw appendages. The series was adapted into anime by MAPPA in 2022 to significant critical and commercial reception.

What distinguishes "Chainsaw Man" in the context of contemporary shonen is its management of tonal register. The series is genuinely funny â€” Denji's desires are comically simple (food, women, normal life) and his pursuit of them generates comedy against the backdrop of apocalyptic violence â€” but the humor does not soften the darkness; it creates contrast that makes the darkness more unsettling rather than less. The deaths of characters the reader has been given reason to care about arrive without the narrative preparation that conventional shonen uses to signal importance, which produces a reading experience of genuine uncertainty: anyone can die, for reasons that may be arbitrary, and the series will continue without them.

Fujimoto's chapter structure is unusually economical. Individual chapters end on transitions rather than cliffhangers, building scenes that develop character and atmosphere at a pace slower than Jump's typical action rhythm. The visual storytelling is precise: Fujimoto communicates emotional states through staging, expression, and physical distance between characters rather than through internal monologue or expository dialogue. This visual economy is more common in seinen manga than in shonen, and its presence in Jump â€” which has commercial incentives toward narrative accessibility â€” is part of what made the series feel unusual in its context.

The female characters in Part 1 are among the series' most discussed elements. Makima, the central antagonist and authority figure, is constructed as an enigma whose appeal and danger are deliberately conflated â€” the reader's uncertainty about whether to trust her mirrors Denji's, and the resolution of that uncertainty is one of manga's more effective villain reveals. Power, the Blood Fiend who becomes Denji's closest companion, is a character of distinctive comedy and unexpected emotional depth whose arc in Part 1 delivers one of the series' most affecting sequences.

Part 2, following a different protagonist in a post-Part-1 world, has developed in directions that divided readers who loved Part 1 while generating new readers who prefer its slower pace and more psychological focus. Fujimoto's willingness to change what the series is across its installments â€” Part 2 is not trying to replicate what Part 1 was â€” is consistent with the creative restlessness that characterizes his complete body of work.`,
...
Both exist and both reward engagement. Declaring one irrelevant to anyone who has seen the other is a category error. The 2003 anime is not a failed attempt at Brotherhood; it is a different work that happens to share an opening, and its emotional register â€” darker, more resigned, more preoccupied with the impossibility of returning things to what they were â€” is a legitimate interpretation of the material that the manga's ultimate optimism chose not to pursue.`,
  ...
  },
  {
    ...
    category: 'anime',
    excerpt: 'Legend of the Galactic Heroes is a 110-episode OVA from 1988 to 1997 built around two protagonists â€” one reforming an autocracy, one defending a corrupt democracy. It is structured around the proposition that neither system is as simple as its advocates claim.',
...
The series' political seriousness is its most distinctive quality. Tanaka and the OVA's writers engage with the question of what democracy actually requires â€” not as a slogan but as a functioning system that depends on an informed and engaged citizenry â€” with enough specificity that scenes set in Alliance legislative bodies generate genuine suspense. Democracy in the series is vulnerable not to military defeat but to the willingness of its citizens to trade political engagement for personal security, and Yang's frustration at watching this happen in real time is the series' most contemporary element. The institutional failures depicted â€” politicians who use democratic language to entrench their own power, citizens who elect demagogues because competent governance is boring â€” are not abstract historical material.
...
The production values of the 1988â€“1997 OVA are dated by contemporary standards, and the 2018 reboot ("Die Neue These") offers more visually modern access to the story. The reboot remains unfinished as an adaptation; the original OVA is complete and remains the full experience. For viewers willing to engage with animation that does not chase contemporary aesthetic standards, the original is preferable for the accumulated weight of 110 episodes of character development â€” Reinhard and Yang's parallel arcs across that length produce an emotional investment that a shorter work cannot replicate.
...
The comparison with Miyazaki is limiting not because Hosoda is lesser but because they are doing different things. Miyazaki's cinema is organized around the world and its strangeness; Hosoda's is organized around the family and its difficulty. The scale is different, the emotional mode is different, and the comparison can only go so far. What Hosoda has built is a consistent body of work with a specific emotional intelligence â€” an understanding of what families ask of each other, and what growing up costs â€” that does not need Miyazaki's shadow to justify its existence.`,
  ...
  },
  {
    ...
    content: `"Fist of the North Star" ("Hokuto no Ken") by writer Buronson and artist Tetsuo Hara serialized in Weekly Shonen Jump from 1983 to 1988, producing 245 chapters and an anime that began airing in 1984. Set in a post-nuclear apocalypse where society has collapsed and the strong prey on the weak, it follows Kenshiro, master of Hokuto Shinken â€” a secret martial art that targets internal pressure points to cause the human body to destroy itself from within. The series generated a franchise that has remained commercially active for four decades and established visual and narrative conventions for post-apocalyptic manga action that subsequent works inherited rather than invented.

The visual design drew heavily from contemporary cultural sources: "Mad Max 2: The Road Warrior" (1981) provided the post-apocalyptic wasteland aesthetic, and Bruce Lee's martial arts iconography provided the physical template for Kenshiro. Hara's art style â€” extremely muscular characters, dynamic action poses, expressive violence â€” was calibrated for maximum kinetic impact in the weekly publication context. The series' visual grammar for depicting fight sequences established conventions that action manga would employ for decades. The exchange "You are already dead" ("Omae wa mou shindeiru") â€” Kenshiro informing defeated opponents that their internal organs are already rupturing â€” became one of the most quoted lines in manga history.
...
The series' limitations are real: its female characters are consistently passive victims or prizes, the episodic structure means emotional investments are regularly abandoned as the story moves to new antagonists, and the violence's escalation eventually produces a kind of numbness. These are the limitations of its moment and commercial context â€” a weekly shonen manga of the mid-1980s was not designed for the sustained character development that subsequent decades of manga would make a standard expectation.
...
What "Fist of the North Star" represents historically is the fusion of Western genre sources with Japanese martial arts storytelling that would become the template for action manga's global appeal. Its visual language was distributed globally through the anime, and its influence on subsequent post-apocalyptic fiction in Japan and internationally is measurable in the directness of its derivatives.`,
  ...
  },
  {
    ...
    content: `"Gintama" by Hideaki Sorachi serialized in Weekly Shonen Jump from 2003 to 2019, producing 77 collected volumes. Set in an alternate-history Edo where feudal Japan has been conquered by aliens and samurai have been stripped of their swords, the series follows Gintoki Sakata â€” a former samurai revolutionary who now runs an odd-jobs shop â€” through a combination of parody comedy, fourth-wall-breaking gag chapters, and serious dramatic arcs that are significantly more emotionally powerful than the surrounding comedy would suggest. The series is the most consistent evidence in manga for the proposition that comedy and genuine feeling are not incompatible.

The gag content is the first thing readers encounter and often the barrier to entry for those who approach manga through the serious tonal register of its more critically discussed works. Gintama's humor is referential, absurdist, and frequently crude, operating through volume and comedic timing rather than narrative elegance. Chapters parody other Jump series, public figures, genre conventions, and the manga industry itself with a freedom that required a popularity robust enough to withstand the consequences. Sorachi's running relationship with Jump's editorial department â€” the joke of a Jump mangaka constantly getting away with breaking the rules â€” is only funny because he is actually getting away with it.

The dramatic arcs work because of the comedy rather than despite it. The Yoshiwara in Flames arc, the Rakuyou arc, and the Farewell Shinsengumi arc are structured as genuine dramatic content â€” character development, stakes, violence with consequences â€” and they land with emotional force because the reader has invested in characters whose comic presentation has revealed rather than concealed their full humanity. Gintoki's backstory, disclosed gradually across the series, makes the comedy's constant deflection of seriousness readable as character rather than narrative evasion: he is someone whose experience of war has made him unwilling to take the world seriously, and the comedy is the expression of that posture.

The supporting cast â€” the Shinsengumi, the Yorozuya, the recurring antagonists â€” is large enough to sustain years of ensemble comedy and developed enough to sustain genuinely affecting dramatic moments centered on relationships the reader has watched develop across hundreds of chapters. Hijikata and Sougo's abusive partnership, Katsura's dedication to a revolution treated with simultaneous sympathy and ridicule, Kagura's alien family obligations â€” each generates material that works as comedy and as something else simultaneously.
...
"Spice and Wolf" occupies a genuinely unusual position in the light novel landscape: a romance for adults who want their romance to also be interesting, a fantasy novel for people who find the genre's action-focus unsatisfying, and an economics text disguised as a love story. All three descriptions are accurate, and their conjunction is why the series has lasted.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'CLAMP â€” four women who began as a doujinshi circle in the 1980s â€” became one of the most commercially successful and visually distinctive manga creation groups in the industry\'s history. Their works span magical girl, dark fantasy, science fiction, and surreal horror.',
    content: `CLAMP is a manga collective of four women â€” Nanase Ohkawa, Mokona, Tsubaki Nekoi, and Satsuki Igarashi â€” who began as a doujinshi circle in the late 1980s and became one of the most commercially successful and artistically distinctive manga creation groups in the industry's history. Their works include "Cardcaptor Sakura," "X/1999," "Magic Knight Rayearth," "Chobits," "xxxHolic," "Tsubasa: Reservoir Chronicle," and "Clover," spanning magical girl, dark fantasy, science fiction, and surreal horror. The range across these titles, and the consistent visual identity maintained across that range, is the first evidence that CLAMP is doing something individual creators rarely achieve across such varied subject matter.

CLAMP's visual style is immediately recognizable: elongated figures with distinctive proportions, elaborate costume design, dense decorative detail in backgrounds and clothing derived from Japanese textile and pattern traditions, and an ability to modulate from cute and accessible to stark and foreboding within single works. "Cardcaptor Sakura" and "X/1999" were produced concurrently â€” one of the most cheerful magical girl series ever drawn and one of the darkest apocalyptic fantasies in manga â€” by the same four people using the same visual vocabulary. The tonal range the style can accommodate is remarkable.
...
"Shirobako" is the work to recommend to anyone who has ever wondered what actually goes into the anime they watch â€” and to anyone who has tried to do creative work professionally and found the distance between love and competence harder to close than they expected.`,
  ...
  },
  {
    ...
    content: `"The Rose of Versailles" ("Versailles no Bara") by Riyoko Ikeda serialized in Weekly Margaret from 1972 to 1973 and was adapted into an enormously successful anime by Tokyo Movie Shinsha in 1979â€“1980. Set in pre-revolutionary France and centering on Oscar FranÃ§ois de Jarjayes â€” a woman raised as a man to serve as commander of the Royal Guard, who serves Marie Antoinette and eventually sides with the revolutionary Third Estate â€” it is one of the most historically and politically ambitious manga ever produced for a young female audience and one of the works most responsible for establishing what shoujo manga could do.

The historical content is substantive. Ikeda researched the French Revolution extensively, and the manga depicts actual historical figures â€” Marie Antoinette, Louis XVI, Robespierre â€” alongside fictional characters with enough contextual accuracy that the series has been used in Japanese secondary school contexts as an introduction to 18th-century French history. The political tensions of the period â€” class resentment, aristocratic privilege, the failure of the monarchy to adapt to social change â€” are depicted with a seriousness that does not simplify in the direction of either revolutionary romanticism or aristocratic nostalgia.

Oscar is the series' defining achievement. A character who inhabits a male social role while maintaining female identity, whose authority is professional and whose emotional life is private, whose relationships with both Andre and with the social world she serves generate the series' deepest dramatic content, she is one of manga's most psychologically complex protagonists. The series' willingness to follow her through contradictions â€” her loyalty to a queen she recognizes as politically destructive, her gradual shift of allegiance as the revolution approaches, her management of her own desire in a social world that has no category for what she is â€” gives "Rose of Versailles" a moral seriousness that the romance content never simplifies.

The influence on subsequent shoujo manga is so pervasive that it is sometimes difficult to identify â€” the conventions it established became the genre's conventions, which makes the origination invisible. The intersection of historical drama and female interiority, the use of male-coded protagonists in female-audience works, the engagement with political content as the context for personal drama: all of these are visible in "The Rose of Versailles" and all became standard tools of the shoujo tradition.

It is one of the works that made the argument, in 1972, that manga for girls could be as serious and as historically ambitious as manga for boys â€” and that argument has been followed by the genre ever since.`,
...
"Parasyte" is a shorter and more structurally contained work than most series discussed in these essays â€” eight collected volumes, a complete narrative. Everything it has to say is said in a bounded space, and the conclusion is the one the premise was always building toward.`,
...
The 2019 remake anime, produced by TMS Entertainment and adapting the complete manga across three seasons, is the version most readers now encounter. The original 2001 anime adapted the first two-thirds without resolution, frustrating readers who had been following the series. The remake's fidelity to the complete text â€” including the manga's darker second half dealing with Akito's backstory and the mechanism of the curse's resolution â€” makes it the definitive adaptation and one of the best recent examples of a faithful manga-to-anime translation.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'Assassination Classroom ran in Weekly Shonen Jump from 2012 to 2016 with a premise designed to resolve in only one way. How Yusei Matsui handles that resolution â€” what the killing means and how the students process it â€” is what determines whether the preceding volumes add up.',
    content: `"Assassination Classroom" ("Ansatsu KyÅshitsu") by Yusei Matsui serialized in Weekly Shonen Jump from 2012 to 2016, producing 21 collected volumes. An octopus-like creature has destroyed most of the moon, announced that he will destroy the Earth within a year, and agreed to teach the bottom-ranked class of a junior high school while allowing â€” requiring â€” his students to attempt to assassinate him. The creature, named Korosensei by his students, moves at Mach 20, is immune to conventional weapons, and is simultaneously the best teacher any of them has ever had. The series is a comedy, a school drama, and, in its final chapters, one of the more emotionally effective endings in recent Jump serialization.

The premise's logic generates its thematic content with unusual tidiness. A teacher who will die at the end of the school year regardless of outcome has no motivation to manage students for his own convenience â€” no reason to hide who they are or dampen their capacities for institutional smoothness. Korosensei's teaching methods are specific to each student's needs rather than calibrated to a median, and the series depicts the bottom-ranked Class E developing competencies â€” combat, social intelligence, academic improvement, the specific skills of assassination â€” that the school's conventional structure had declared them incapable of. The extended metaphor of assassination-as-education (learning to understand someone deeply enough to find their weaknesses) is the organizing logic of both the comedy and the character development.

The students â€” a class of twenty-eight, each with distinct characterization â€” are the series' largest structural achievement. Maintaining character differentiation across that number of characters at weekly publication pace for four years is a technical accomplishment the series largely achieves. The moments when individual students' arcs reach resolution â€” their assassination attempts, their academic developments, their growing understanding of what Korosensei is actually teaching them â€” are distributed across the run with enough frequency that the cast never feels neglected despite its size.

The series' final arc requires the premise's logic to follow through on what it has always implied: Korosensei will die, and the class will be the agents of that death. How Matsui handles this resolution â€” what the killing means, how the students process it, and what the series ultimately says about the relationship between teacher and students â€” is the work's most significant test and the element that determines whether the preceding volumes add up to what they promised.
...
The ending earns the preceding content. That is not as common in Jump serialization as it should be, and it is worth saying plainly.`,
  ...
  },
  {
    ...
    category: 'light-novels',
    excerpt: 'Tensura is not interested in suffering as characterization. Its power fantasy is unusually specific: not combat dominance but administrative competence â€” being the person who builds something good through intelligence and preparation rather than through violence.',
...
The tonal distinction from darker isekai â€” Re:Zero, Mushoku Tensei â€” is immediate and intentional. "Tensura" is not interested in suffering as characterization or in the costs of violence as thematic material. Its protagonist is competent from the beginning, his alliances generally succeed, the monsters he leads are given agency and warmth, and the series' satisfactions are primarily the satisfactions of watching a well-organized person building something good. The power fantasy is unusually specific: not fantasy of combat dominance but of administrative competence â€” of being the person who can organize a city, manage competing interests, and solve problems through intelligence and preparation rather than through violence.

The monster community â€” the city of Tempest, built by Rimuru for the monsters who have aligned with him â€” is the series' most appealing element. The characters who populate it, from the goblin leaders to the Ogre warriors to the various beings who join across the series, are developed with enough individuality that the city functions as a community rather than a backdrop. The series is genuinely interested in what it would take to build a stable society from scratch, and the nation-building content â€” trade agreements, defensive alliances, social organization â€” is developed with more specificity than most isekai attempts.
...
"Tensura" sits at the other end of the isekai spectrum from Re:Zero and Mushoku Tensei and is not trying to be them. It is trying to be the fantasy of competence and community-building done well, and within those terms it largely succeeds.`,
  ...
  },
  {
    ...
    category: 'industry',
    excerpt: 'In 2001, Tokyopop adopted unflipped pages and a $9.99 price point and changed how manga reached English-speaking readers. What followed was a genuine cultural mainstreaming of manga â€” and a collapse that reshaped the industry for a decade afterward.',
    content: `In 2001, Tokyopop â€” a Los Angeles-based publisher founded by Stu Levy in 1996 â€” made two decisions that changed how manga reached English-speaking readers: it adopted the "100% Authentic Manga" format (right-to-left reading, unflipped pages, smaller trim size) and implemented a $9.99 price point for single volumes. Previous manga translation in the United States had "flipped" pages to read left-to-right, altering artwork composition and requiring text redraws; Tokyopop's decision to preserve original reading direction treated manga as a format with its own conventions rather than a variant of American comics. The lower price point opened a mass-market audience that the $15â€“20 price of previous releases had excluded.

What followed between 2001 and 2007 was the American manga boom: a period in which manga volumes became a significant presence in mainstream bookstores â€” Borders, Barnes & Noble, Walmart â€” rather than specialty comic shops, in which annual manga sales grew from under $50 million to over $200 million in the US market, and in which properties like "Fruits Basket," "Naruto," "Fullmetal Alchemist," and "Inuyasha" achieved bestseller status. The boom represented a genuine cultural mainstreaming of manga as a format, driven partly by anime's simultaneous presence on Cartoon Network's Toonami block, which had introduced the properties that readers were now seeking in print.

Tokyopop's role in the boom included both commercially successful licensed titles and an initiative â€” the "Rising Stars of Manga" contest and subsequent "OEL" (Original English Language) manga program â€” that attempted to develop Western creators working in manga-influenced styles. The OEL program was commercially unsuccessful and generated criticism from Japanese publishers who objected to the use of the manga label for non-Japanese work, but it represented a genuine attempt to determine whether the format had cross-cultural viability as a creative mode rather than simply as a distribution channel for Japanese content.

The boom ended between 2007 and 2009, driven by a combination of market saturation, the 2008 financial crisis's effect on discretionary spending, the rise of scanlation providing free access to unlicensed titles, and Tokyopop's own contractual problems with publishers and creators. Tokyopop ceased North American publishing operations in 2011. The manga market subsequently stabilized at a lower level, consolidated around fewer publishers â€” Viz Media, Kodansha USA, Yen Press â€” and was revived in the mid-2010s by digital platforms and Crunchyroll's simulcast model creating anime audiences who sought source manga.
...
The boom and its collapse are the most significant event in the history of manga publishing in English, and their lessons about format accessibility, price points, and the relationship between anime viewership and manga readership continued to shape industry decisions for a decade after Tokyopop's exit.`,
  ...
  },
  {
    ...
    category: 'industry',
    excerpt: 'Joe Hisaishi has composed the scores for almost every major Studio Ghibli film across forty years. The emotional landscape of Ghibli\'s films is inseparable from what he brought to them. Great film music is heard and not consciously noticed â€” Hisaishi\'s scores are, by this measure, the most successful film music of the last forty years.',
    content: `Joe Hisaishi has composed the scores for almost every major Studio Ghibli film: "NausicaÃ¤ of the Valley of the Wind" (1984), "Castle in the Sky" (1986), "My Neighbor Totoro" (1988), "Kiki's Delivery Service" (1989), "Porco Rosso" (1992), "Princess Mononoke" (1997), "Spirited Away" (2002), "Howl's Moving Castle" (2004), "Ponyo" (2008), "The Wind Rises" (2013), and "The Boy and the Heron" (2023). The list spans forty years of collaboration, and the emotional landscape of Ghibli's films is inseparable from what Hisaishi has brought to them. To identify what Ghibli sounds like is to identify what Hisaishi sounds like.

Hisaishi's compositional approach draws on classical European film scoring traditions while incorporating elements from minimalism and Japanese musical culture. His most characteristic work uses sustained melodic lines over relatively simple harmonic structures, trusting the melody to carry emotional weight that busier arrangements would distribute across more elements. The theme from "My Neighbor Totoro" â€” a melody the film states and then returns to in various contexts â€” is among the most emotionally immediate pieces of film music ever written, and its simplicity is the source of its power rather than a limitation of it.

The collaborative relationship between Hisaishi and Miyazaki is long enough and close enough that attributing specific musical choices entirely to either is impossible. Miyazaki has been involved in the emotional specification of scores â€” what a sequence should feel like, what emotional register a transition should produce â€” and Hisaishi has shaped the timing and pacing of scenes around his musical ideas. The collaboration is closer to co-authorship than to a director using a hired composer, and the quality of both men's work in the partnership exceeds what either has produced most frequently in other contexts.

The "Princess Mononoke" score is perhaps Hisaishi's most ambitious Ghibli achievement. The film's subject â€” ecological conflict with no easy resolution â€” required music that could hold opposing forces without resolving them into a simple emotional register. Hisaishi's approach â€” combining orchestral weight with Japanese instruments, maintaining melodic beauty within harmonic complexity â€” produced a score that functions as its own argument about the film's themes rather than simply illustrating them.
