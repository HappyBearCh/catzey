/**
 * Second batch of editorial essays â€” landmark works, creators, genre histories, industry.
...
const ESSAYS = [
  // â”€â”€ LANDMARK WORKS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    ...
    content: `"Neon Genesis Evangelion" premiered in October 1995. It was designed, at least initially, as a commercially safe mecha series â€” giant robots, a teenage pilot, episodic monster battles â€” the kind of show that had reliably sold toys and model kits since the 1970s. What it became instead was one of the most psychologically disturbing, formally experimental, and culturally significant animated works ever produced. The gap between what it was supposed to be and what it became is the story of Hideaki Anno, the man who made it, and the state he was in while making it.

Anno had spent the four years before Evangelion in a depressive episode so severe that he described being unable to do anything at all â€” no work, no social contact, nothing. When he emerged from it and began developing the series, he used the show as a vehicle for processing that experience in ways that became increasingly direct as production continued. The early episodes function as a reasonably competent action series. As the series progresses, the psychological content becomes more explicit, the narrative structure more fragmented, and the protagonist Shinji Ikari's interiority more central than the battles he is nominally fighting. By the final two episodes â€” produced when the studio had run out of money and could no longer afford conventional animation â€” the show had become an extended internal monologue staged almost entirely through still images, text, and voice.

Those final episodes produced a crisis of audience expectation so acute that Gainax received death threats from fans who felt that the conventional ending they had been promised had been withheld. Anno and several other staff members received threatening letters. The studio responded by producing "The End of Evangelion" (1997), a theatrical film providing an alternative ending that delivers the apocalyptic spectacle the television ending denied â€” and then surrounds it with content so bleak and accusatory toward the audience itself that it functions less as a concession than as a confrontation.

The cultural impact of Evangelion is now so thoroughly absorbed into anime that it is difficult to see clearly. Series that interrogate their own genre conventions, protagonists who are defined by psychological damage rather than simple heroism, narratives that deliberately withhold resolution â€” all of these were present in anime before 1995, but Evangelion made them legitimate at a mass audience level in ways that had not existed before. It also established a commercial model â€” the "rebuild," the repackaged rerelease, the franchise extended through new productions years after the original â€” that the anime industry has reproduced extensively.

Anno spent the years after the original Evangelion in and out of depression, making films and returning eventually to produce the "Rebuild of Evangelion" tetralogy, a four-film reimagining of the original series. The final film, "Evangelion: 3.0+1.0 Thrice Upon a Time," was released in 2021 after years of delays. It is, by most readings, a work of genuine closure â€” Anno processing and releasing something he had carried for twenty-five years. Whether it succeeds as a work of art independently of that autobiographical context is a question viewers continue to debate.`,
...
Arakawa's own background â€” she grew up on a dairy farm in Hokkaido and worked on the farm before becoming a manga artist â€” informs the series in ways that are not obvious but are real. Her depictions of labor, of the physical cost of work, and of the kinds of knowledge that come from working with land and animals give the series an earthiness that its elaborate fantasy plotting does not diminish. She is not a writer who romanticizes work or struggle; her characters earn what they achieve, and the earning is shown, not elided.`,
...
The final manga chapters and the concluding anime episodes divided fandom in a way that is itself notable: the disagreement about whether the ending is brilliant or a betrayal has been conducted at a level of engagement and sophistication that demonstrates how seriously its audience took the work. Bad endings to beloved series are not uncommon. Endings that provoke this volume of analytical response â€” that force readers to examine what they thought the work was about and whether the author's conclusion is consistent with that reading â€” are much rarer. Whatever the verdict, "Attack on Titan" demanded to be taken seriously, and its audience obliged.`,
  ...
  // â”€â”€ CREATORS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    ...
    content: `Hayao Miyazaki was born in Tokyo in 1941, the second of four sons in a family that manufactured airplane parts for the Japanese military. His childhood coincided with the firebombing of Tokyo; his first memories of urban Japan were of a city in ruins. He grew up reading manga and became obsessed with animation, joining Toei Animation in 1963 as an in-between artist â€” the entry-level role of drawing the intermediate frames between key poses that more senior animators produced. He was, by all accounts, extremely good at it, and extremely unhappy doing it.

The path from Toei to Ghibli ran through two decades of animation work on television and film, a creative partnership with Isao Takahata (a director of even greater austerity than Miyazaki, whose "Grave of the Fireflies" and "My Neighbor Yamada" occupy positions at opposite ends of emotional devastation), and the unexpected theatrical success of "NausicaÃ¤ of the Valley of the Wind" in 1984 â€” a film based on Miyazaki's own ongoing manga that performed well enough commercially to justify founding a studio specifically to continue making his films. Studio Ghibli was established in 1985, and its first production was "Castle in the Sky."

The consistency of the Ghibli filmography across four decades is almost without parallel in cinema. The films are visually extraordinary â€” every frame is composed with a care for light, environment, and movement that reflects decades of accumulated craft â€” but they are also emotionally intelligent in ways that distinguish them from the mass of animated entertainment. Miyazaki's films are interested in the interiority of their characters, particularly their female protagonists, in a way that many filmmakers working in animation have not been. His heroines are neither passive nor defined by romantic aspiration; they are curious, capable, and allowed to be ambivalent, afraid, and complicated.

"Spirited Away," released in 2001, became the highest-grossing film in Japanese history, surpassing "Titanic." It won the Academy Award for Best Animated Feature in 2003, the first non-English-language film to do so. "Princess Mononoke," "Howl's Moving Castle," "My Neighbor Totoro," and "Kiki's Delivery Service" have each achieved the status of cultural classics not merely in Japan but globally â€” works that are considered, by audiences who have otherwise minimal engagement with animation, to be simply great films.

Miyazaki announced his retirement in 1997, after "Princess Mononoke," and returned to make "Spirited Away." He announced retirement again in 2013, after "The Wind Rises," and returned to make "The Boy and the Heron" (2023), which won the Academy Award for Best Animated Feature. He is now in his early eighties and reported to be working on another project. The pattern suggests that retirement is, for him, a condition of recharging rather than stopping. The question of what Ghibli will be after Miyazaki â€” a question the studio itself is actively working to answer â€” is one of the more significant open questions in world cinema.`,
...
The decision was not announced. Evangelion was pitched to sponsors as a commercially viable mecha series â€” the market for giant robot toys was reliable, the format was proven. Gainax needed the production to succeed financially, and Anno knew that a series explicitly marketed as an autobiographical exploration of clinical depression would not attract the necessary investment. The commercial shell remained intact through the early episodes. What shifted as the production continued was Anno's relationship to his material: the further the series went, the more directly it engaged with the interior states he had been living through.

The character of Shinji Ikari â€” the reluctant pilot who is asked to fight world-ending threats and consistently fails to summon the will to do so â€” is, in ways Anno has confirmed, a self-portrait. The persistent question the series asks of Shinji, and through him of the audience, is why it is so difficult to choose to engage with life when the cost of not engaging is so clearly catastrophic. This is a clinical description of certain depressive states, and Anno stages it not as a problem to be solved but as a condition to be examined. The series does not resolve it; it investigates it.

After the original Evangelion and its theatrical conclusion "End of Evangelion," Anno spent years in and out of production. He directed "Cutie Honey" (2004), a tokusatsu film, and co-wrote "Shin Godzilla" (2016), a political monster film that was received in Japan as one of the finest Godzilla productions in decades. The "Rebuild of Evangelion" tetralogy, which he produced over fifteen years, represents his attempt to return to the material with some distance â€” to remake the story with craft and perspective that the original's chaos did not allow. Whether it improves on the original or merely clarifies it is a question that serious viewers of both works continue to debate.

Anno has said that completing the final Rebuild film, "Thrice Upon a Time," felt like closure â€” that he had finished with Evangelion in a way he had not been able to in 1997. He is now in his early sixties and continues to work. What his career demonstrates, more clearly than most, is that the relationship between a creator's mental state and their creative output is not always tragic â€” that sometimes the work that emerges from the worst period is the work that matters most, and that surviving it makes subsequent work possible.`,
...
Ito's horror operates through the violation of the familiar. His stories begin with premises that are recognizably domestic â€” a girlfriend, a small town, a collection of used clothing â€” and then introduce single elements of wrong so precise and escalating that what seemed normal becomes unbearable. The genius is in the escalation: Ito identifies exactly how far a wrong premise can be extended before the reader fully comprehends the scope of what is happening, and he consistently extends it further. By the time the full horror is revealed, the reader has been implicated in their own building dread.

His most celebrated work, "Uzumaki" (1998â€“1999), follows a town that becomes obsessed with spiral shapes. The premise sounds absurd summarized; the execution is among the finest sustained horror fiction produced in any medium. Ito uses the spiral â€” a shape that recurs in nature, in mathematics, in architecture â€” as a vessel for something genuinely inexpressible, something that the mind registers as wrong before it can articulate why. The visual grammar of manga, with its controlled revelation of information panel by panel, turns out to be ideally suited for this kind of horror. You cannot look away from the next panel; the format makes looking away impossible.

His influence on Western horror artists has been substantial and widely acknowledged. The directors of "It," "Hereditary," and "Midsommar" have cited him. His aesthetics appear in video games, in musical album artwork, in fashion. The image of Tomie â€” his recurring antagonist, an immortal, unkillable girl who drives men to murder and returns from every death to start again â€” has achieved the kind of cultural saturation that places her alongside Frankenstein's monster and Dracula as an immediately recognizable horror icon.

Ito has said in interviews that his horror tends to emerge from mundane anxieties rather than extreme ones â€” the fear of specific shapes, of social situations, of the body behaving in unexpected ways. The specificity of these anxieties, their rootedness in ordinary life, is what makes his work find audiences far outside the horror genre's usual readership. You do not need to like horror to recognize, in Ito's images, something that responds to genuine psychological fear rather than mere shock.`,
...
The mecha genre's contemporary form is far more diverse than its 1970s origins suggest. Works like "Darling in the FranXX," "86," and "Aldnoah.Zero" continue to use piloted machines as vehicles for examining questions about war, identity, and what it costs to be the person who fights. Others, like "Gurren Lagann," use the genre's conventions for deliberate emotional maximalism â€” more interested in the feeling of escalating power than in its cost. The genre is large enough to contain both. What it cannot contain, without ceasing to be itself, is robots that mean nothing â€” machines that are merely spectacle without the weight of the cultural history they carry.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'Takehiko Inoue\'s Slam Dunk ran for only four years, but its impact on Japanese basketball â€” and on the sports manga genre â€” has lasted thirty. Here\'s how a comic changed a sport.',
    content: `In the early 1990s, basketball was a niche sport in Japan. The country's athletic culture was dominated by baseball and sumo, with football (soccer), judo, and swimming occupying the next tier. Basketball existed â€” there were school teams, there was a domestic league â€” but it had nothing like the cultural presence it needed to produce serious competitive players at scale. Then "Slam Dunk" began serialization in Weekly Shonen Jump in October 1990, and over the next four years the sport's profile in Japan changed fundamentally.
...
The sports manga genre that "Slam Dunk" belongs to has a specific tradition in Japanese comics â€” series like "Captain Tsubasa" (soccer, which is widely credited with fueling the soccer boom that led to Japan's 2002 World Cup co-hosting), "Haikyuu!!" (volleyball), "Kuroko's Basketball," and "Daiya no A" (baseball) use the sports narrative structure â€” training, tournament, rivals, breakthrough â€” as a vehicle for examining themes about teamwork, individual excellence, and the relationship between talent and effort that are not specific to the sport depicted.

What distinguishes the best sports manga from the genre's lesser examples is the quality of attention to the sport itself. "Slam Dunk" does not merely use basketball as a backdrop for character drama; it depicts basketball with enough specificity and love that readers who have never played the game develop an understanding of what makes it beautiful. This kind of specific attention â€” what you might call genre honesty â€” is the difference between sports manga that changes how people see a sport and sports manga that merely uses a sport for its setting.`,
  ...
  },
  {
    ...
    content: `Horror in Japanese manga has roots that run deeper than its Western counterparts recognize. The kamishibai â€” paper theater, a storytelling tradition in which illustrated cards were presented sequentially on a small stage by traveling performers â€” was already delivering horror narratives to children in Japan during the postwar period. The card format, revealing images one at a time with narration between each, is structurally similar to manga's panel-by-panel revelation. The visual vocabulary of Japanese horror â€” the specific way shadows fall, the specific facial expressions that register supernatural dread â€” developed in kamishibai before it migrated into manga.

Kazuo Umezu, born in 1936, is the figure most responsible for establishing horror manga as a serious genre. His work in the 1960s and 1970s â€” "The Drifting Classroom," "Orochi," "Cat Eyed Boy" â€” demonstrated that manga could sustain horror of genuine intensity across extended narratives. "The Drifting Classroom" (1972â€“1974) is his masterpiece: an elementary school is transported to a post-apocalyptic wasteland, and the story follows the children's attempt to survive in conditions of absolute extremity. It is genuinely terrifying and also genuinely humane â€” Umezu's horror is never merely shocking; it uses extreme circumstances to examine what children actually are, what they are capable of under duress, what they need from adults and what happens when adults are not available.

The generation of horror manga artists that followed Umezu â€” including Hideshi Hino, whose grotesque body horror comics occupied their own disturbing territory â€” developed the genre's visual vocabulary toward more explicit imagery. The boundary between horror and exploitation has always been contested in manga as in film, and certain works from the 1980s and 1990s inhabit that boundary in uncomfortable ways.

Junji Ito, who trained under no one and developed his approach in isolation, represented a third direction: horror that derived its power not from explicit violence or transgressive content but from the specifically wrong image â€” the impossible shape, the expression that should not exist, the figure in the photograph that no one can explain. His methods draw on surrealism and on the specifically Japanese tradition of the kaidan â€” the ghost story â€” more than on Western horror conventions. The result is work that frightens audiences in different cultures for recognizably similar reasons, which suggests it is engaging with anxieties that are not culturally specific.

The global reach of Japanese horror manga â€” through Ito's international publication, through horror anime adaptations, through the influence of Japanese horror aesthetics on Western horror cinema (the visual conventions of films like "The Ring" and "The Grudge" are deeply indebted to Japanese horror manga) â€” has made this one of the most successfully exported Japanese cultural forms. The specific way Japanese horror looks, the specific feelings it generates, have become part of a global visual language of fear.`,
...
The genre's prevalence in Japan reflects real cultural weight attached to food expertise. The Michelin Guide to Tokyo has more starred restaurants than any other city in the world. The concept of "shokunin" â€” the artisan who devotes their life to mastering a single craft â€” is culturally honored in Japan in ways that make a manga devoted to a character spending their career perfecting one dish feel not absurd but admirable. The food manga genre is, in this sense, the shokunin ethic applied to narrative.`,
  ...
  // â”€â”€ INDUSTRY AND CULTURE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
...
The committee system is not going away â€” its financial logic remains compelling â€” but the rise of streaming platforms as direct commissioners of anime content has introduced an alternative financing model. When Netflix or Amazon directly commissions a series, they function effectively as a single committee member with majority control, which can actually increase creative freedom by reducing the number of stakeholders whose interests must be accommodated. The tradeoff is a different form of constraint: the platform's preferences for content that performs well in international markets shapes production in its own ways.`,
  ...
  },
  {
    ...
    category: 'industry',
    excerpt: 'In Japan, the voice actors who bring anime characters to life are celebrities in their own right â€” with solo music careers, touring concerts, and dedicated fan bases. Here\'s how this uniquely Japanese phenomenon developed.',
    content: `In most countries, voice acting is a craft practiced by skilled professionals who remain largely unknown to the audience whose favorite characters they voice. In Japan, the relationship between anime voice actors â€” seiyuu â€” and their audience is fundamentally different. Major seiyuu have management agencies, release music singles, perform at concerts, and command fan bases whose devotion is comparable to that given to pop stars. The voice behind a beloved character is, in Japan, a public figure in their own right.

The phenomenon has roots in the 1970s and 1980s, when voice actors began appearing at fan events and being identified by name in anime credits. As anime fandom deepened and became more self-conscious â€” as fans began to discuss production in detail and to care about the craft behind what they watched â€” the voices became as important as any other element. Fan magazines began profiling seiyuu; mail-in surveys asked viewers to rank their favorite voice performances.
...
Today, the seiyuu industry is substantial and highly competitive. Voice acting schools in Japan graduate thousands of students annually, competing for positions in a market where the top performers earn celebrity-level salaries and the majority earn at or near minimum wage. The audition culture is intense; a single major role can transform a career. Agencies manage the careers of their seiyuu not merely as voice performers but as multimedia entertainers â€” voice work, music, events, merchandise, and social media presence are all part of the package.

The "live voice" events that have become a significant part of the industry â€” concerts at which seiyuu perform the songs from series they work on, sometimes in costume, with anime footage playing behind them â€” are a distinctly Japanese cultural form with no real Western equivalent. Tens of thousands of fans pay concert prices to hear the voice behind their favorite character sing in a stadium. The transaction is unusual only if you forget that in Japan, a voice is not merely a production element but a presence â€” a person whose craft has given life to something the audience loves, and who deserves to be loved for it.`,
...
The infrastructure of French manga fandom has grown to match the market. Japan Expo, the annual convention held outside Paris, regularly attracts over 250,000 visitors â€” one of the largest anime and manga conventions in the world. French manga critics and scholars have produced serious academic work on the medium. Several French illustrators have produced work in manga-influenced styles that circulates in Japan as well as France, creating a creative exchange that runs in both directions. The relationship between France and Japanese popular culture is, at this point, genuinely bilateral.`,
  ...
  },
  {
    ...
    category: 'industry',
    excerpt: 'Visual novels â€” story-driven PC games with branching narratives â€” have produced some of anime\'s most beloved series. The pipeline from doujin game to global franchise is a uniquely Japanese creative path.',
...
"Fate/stay night," developed by Type-Moon and first released in 2004, follows a teenager who is accidentally enrolled in a secret magical tournament in which participants summon historical heroes as supernatural servants. The visual novel's branching structure allowed it to develop three distinct narrative routes â€” Fate, Unlimited Blade Works, and Heaven's Feel â€” each emphasizing different characters and philosophical concerns. The game became a phenomenon in Japanese niche gaming culture before a 2006 anime adaptation by Studio Deen brought it to a mainstream audience. The franchise has since expanded to include multiple series, films, spin-offs, and a massively successful mobile game, Fate/Grand Order, that reportedly earns hundreds of millions of dollars annually.

"Clannad," produced by Key in 2004, is a visual novel about a delinquent student who befriends a series of girls, each with their own story of loss or difficulty, and gradually learns what family and responsibility mean. Its emotional ambition is extraordinary for a game format â€” several routes end in grief of unusual intensity â€” and its anime adaptation by Kyoto Animation (2007â€“2009) is still considered among the finest dramatic anime ever produced. Key, the studio behind "Clannad," also produced "Kanon," "AIR," "Little Busters," and "Angel Beats," establishing a recognizable voice in emotional drama that the anime adaptations of those works carried to audiences who never played the originals.

"Steins;Gate," developed by 5pb. and Nitroplus in 2009, follows a self-proclaimed mad scientist who accidentally invents a method of sending messages back in time, with progressively catastrophic consequences. It is a science fiction thriller of unusual structural sophistication â€” the visual novel format's branching pathways are used to create genuine time-loop mechanics that the reader experiences rather than merely reads about. The 2011 anime adaptation compressed the narrative in ways that served the thriller structure while preserving its emotional core; it is now regularly cited as one of the best science fiction anime ever made.

The visual novel to anime pipeline works because visual novels, by their nature, produce extensive narrative material â€” dozens of hours of story, multiple character routes, elaborately developed worlds â€” that anime can draw on. The challenge is compression: a 50-hour visual novel route must become 12 anime episodes. The studios that have done this successfully â€” Kyoto Animation with Key's works, ufotable with Fate â€” have understood that adaptation requires selection rather than reduction: choosing which moments to preserve in full rather than summarizing everything and capturing nothing.`,
  ...
  },
  {
    ...
    category: 'industry',
    excerpt: 'For decades, volunteer groups scanned, translated, and distributed manga online for free, reaching audiences that publishers couldn\'t. Here\'s the complicated legacy they left â€” and how the industry eventually adapted.',
    content: `Before legal digital manga was available in English, the only way to read the majority of manga that was actively being published in Japan was through scanlations â€” digitally scanned pages translated by fan volunteers and distributed freely online. The practice was unambiguously illegal, unambiguously widespread, and historically complicated in ways that straightforward moral condemnation does not capture.
