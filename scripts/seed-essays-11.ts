...
The "god of manga" designation, which Tezuka himself reportedly found uncomfortable, reflects what the Japanese comics industry owes him: not just the visual language and the narrative conventions but the cultural legitimacy — the claim that manga was a form serious enough for adult engagement and for serious artistic ambition. Every creator discussed in these essays is working in a tradition he established.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'Pluto takes a single arc from Osamu Tezuka\'s Astro Boy — the Greatest Robot on Earth — and retells it as a story about the aftermath of war, the politics of hatred, and whether machines that can feel grief can be said to have human rights. It is the most respectful and most transformative homage in manga history.',
    content: `"Pluto" by Naoki Urasawa and Takashi Nagasaki, produced with the authorization of the Tezuka estate, serialized in Big Comic Original from 2003 to 2009, producing eight collected volumes. The work adapts "The Greatest Robot on Earth" arc from Osamu Tezuka's "Astro Boy" — in which the world's most powerful robots are hunted and destroyed one by one — retelling it from the perspective of Gesicht, a European robot detective investigating the murders, rather than from Astro Boy's perspective. The transformation is total: what was an action-adventure arc for children becomes a political thriller about the aftermath of a war that closely parallels the Iraq War, and about the nature of hatred, grief, and what it means to be conscious and mortal.

Urasawa's formal intelligence in adapting a children's manga is the work's primary achievement. He preserves the major plot points of Tezuka's arc — the sequence of robots who are killed, the mystery of the antagonist, the resolution involving Pluto himself — while filling the spaces between those points with political and psychological content that the original's audience and format did not require. The robots in Urasawa's version feel pain, grieve, dream, and are capable of hatred — which transforms the question of their destruction from an action narrative about power into an ethical inquiry about what destroys a mind and whether a mind that can be destroyed is owed the same protections as a human one.

The war in the background — a robot-assisted conflict in which the strongest robots were deployed to end a human war — is unmistakably derived from the Iraq War's political context, and the consequences for both the deployed robots and the population of the "defeated" country are depicted with a political seriousness unusual for manga drawing on a children's source. The robots that participated in the war are damaged by it in ways that parallel combat trauma; the human survivors of the occupied country carry a specific hatred that the narrative traces to its origins without excusing its consequences.

Tezuka's "Astro Boy" ends its arc with the original optimism of a children's story: evil is defeated, the world is safer. Urasawa's "Pluto" ends with a more complicated resolution that honors Tezuka's emotional commitments while refusing his narrative simplifications. The final sequence — which depends on the reader's knowledge of Tezuka's version for its full impact — is one of manga's most moving examples of a work achieving its emotional effect through dialogue with its source rather than through independent construction.
...
The 2023 Netflix anime adaptation, produced by Studio M2, was among the year's most ambitious anime productions, preserving Urasawa's deliberate pacing and using the animated format to realize the scale of the work's most visually ambitious sequences.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'Bleach\'s Soul Society arc is one of the most acclaimed extended sequences in shonen history. The series then spent years losing what made that arc work. The Thousand-Year Blood War anime adaptation, arriving in 2022, finally gave the manga\'s finale the production quality it deserved — and demonstrated that the ending was better than its reputation.',
    content: `Tite Kubo serialized "Bleach" in Weekly Shonen Jump from 2001 to 2016, with the anime running from 2004 to 2012 before going on hiatus as it caught up to the manga. The series follows Ichigo Kurosaki, a teenager with the ability to see ghosts who accidentally acquires the powers of a Soul Reaper — a death god tasked with guiding souls to the afterlife and fighting Hollows, the malevolent spirits that threaten them. The first two arcs established a world of unusual visual richness and tonal confidence; the Soul Society arc, in which Ichigo infiltrates the Soul Reapers' home realm to rescue a wrongly condemned friend, is one of the most well-constructed extended sequences in shonen history.

The Soul Society arc works for reasons that are worth identifying precisely. The antagonists — the Thirteen Court Guard Squads, each led by a captain with a distinct fighting style and personality — are introduced in sequence, each with enough characterization to feel like a genuine obstacle rather than a placeholder. The arc's central mystery — why Rukia was condemned, who authorized her execution, what the Soul Society is concealing — is constructed with enough layering that its revelation reframes what the reader understood about the preceding chapters. And Byakuya Kuchiki, Rukia's adoptive brother and the arc's primary antagonist, is developed with enough moral complexity that his defeat feels like a genuine dramatic resolution rather than a simple villain elimination.

The Arrancar and Hueco Mundo arcs that followed maintained the series' quality while expanding its world. The Aizen reveal — which retroactively recontextualized the Soul Society arc's conspiracy — is one of shonen manga's most carefully prepared plot twists. But the Fullbring arc and the extended Quincy arc that concluded the manga's original run were received as declining in the specific quality that made the Soul Society arc work: the construction of antagonists as individuals rather than as power-level representatives, and the management of a large cast with enough attention that each character's function felt earned.

The Thousand-Year Blood War arc's anime adaptation, produced by Pierrot with significantly improved production values and beginning in 2022, reintroduced the series to a generation of viewers who had heard about its decline and gave long-term fans their first opportunity to see the manga's final arc realized in animation. The adaptation demonstrated that the Quincy arc — whatever its weaknesses relative to the Soul Society peak — contained genuine creative ambitions that the original anime's cancellation had prevented from reaching an animated audience. The visual realization of Yhwach's Quincy mythology, and the final confrontation between Ichigo and the series' ultimate antagonist, arrived with enough craft to constitute a genuine conclusion to a series whose reputation had been defined by its middle rather than its ending.`,
...
The Netflix anime adaptation by Orange, produced in CGI that proved surprisingly effective at conveying the series' emotional content, was one of the more acclaimed anime of its seasons. Orange's CGI approach — different from the flatter CGI that anime had historically used, influenced by stop-motion aesthetics in its character movement — gave the series a visual texture that supported rather than undermined the material.`,
  ...
  },
  {
    ...
    content: `"Land of the Lustrous" ("Houseki no Kuni") by Haruko Ichikawa serialized in Monthly Afternoon from 2012 and continues. The series is set in a far future where the Earth is inhabited by gem-people — living crystalline beings who fight off repeated attacks by the Lunarians, mysterious beings who descend from the moon to shatter the gems and use their fragments as decorations. The protagonist, Phosphophyllite, is the weakest and most brittle gem, assigned to chronicle the world's history because their fragility makes them useless in combat. The premise is visually imaginative and the early volumes are among the most visually distinctive manga of the 2010s. The later volumes are among the most emotionally demanding.

Ichikawa's visual style — thin precise lines, detailed crystalline textures, the specific way light moves through gem bodies — is immediately distinctive and perfectly calibrated to the subject. The gem-people are not human-shaped in the way that most fantasy beings are; they have the specific visual properties of their mineral origins, and the series' action sequences use those properties: when a gem is shattered, the fragments are still conscious, and the regeneration from fragments — or the failure to recover all the pieces — generates the series' primary form of permanent damage.

The turn the series takes — in which Phos gradually trades their original materials for more powerful substances, losing pieces of their original self with each trade, while the social world around them transforms in response to revelations about the Lunarians' origins and the nature of the gem-people's existence — produces a narrative of identity erosion that has no equivalent in other manga. Phos at the series' late stages is not the same person who appeared in the early volumes in any meaningful sense: the trades have changed the body, the memories have been fragmentary and inconsistently recovered, and the decisions made in an earlier state of self cannot be fully claimed by the current one. The series asks, without resolving, at what point accumulated change becomes replacement rather than development.

The 2017 anime adaptation by Orange used CGI to render the gem-people's crystalline bodies in a way that hand-drawn animation could not achieve, and the visual achievement was widely acknowledged as among the most successful uses of CGI in anime. The adaptation covered the manga's first several arcs before the narrative transformed into its more difficult later content — making it an effective entry point that does not prepare the viewer for where the manga goes.`,
  ...
  },
  {
    ...
    content: `"Love Live! School Idol Project" launched as a multimedia franchise in 2010 — simultaneously a manga in Dengeki G's Comic, a music project releasing character songs, and an interactive element that allowed fans to vote for which characters would be featured on magazine covers. The anime adaptation, produced by Sunrise in 2013, took this accumulated character investment and built a story around nine high school girls forming a school idol group to save their school from closure. The franchise became one of the most commercially successful in anime history and defined the cultural model for the idol anime genre's second wave.

The idol anime genre has a longer history than Love Live — "THE iDOLM@STER" originated as an arcade game in 2005 and generated anime from 2011 onward, and various idol-adjacent anime had existed throughout the medium's history — but Love Live's specific contribution was the synthesis of participatory franchise mechanics with conventional anime storytelling. The fan voting element, which gave the audience a sense of investment in the characters before the anime began, was carried into the anime's production process: the franchise's success created a relationship between the music releases, the live concerts performed by the voice actresses, and the anime narrative that made each element reinforce the others rather than existing independently.

The Love Live model — a group of girls forming an idol unit, each member designed to appeal to a specific demographic within the fanbase, competing in a national competition — was formalized enough that subsequent idol anime (Love Live! Sunshine!!, Love Live! Nijigasaki High School Idol Club, BanG Dream!, Idolish7) operate within its structural template. The variations between franchises are primarily in setting and character emphasis rather than in fundamental approach, which reflects the genre's commercial logic: the template works, and the market for alternatives to it is smaller than the market for refinements of it.

The voice actress performances at live concerts — where the women who voice the characters perform the characters' songs on stage — are a specific form of parasocial investment that the idol anime genre uniquely enables. The overlap between the fictional character's fan appeal and the real person's public presence creates a fandom ecosystem that is more emotionally complex than standard anime fandom, involving the specific pleasures and pressures of following real performers through the lens of fictional characters they embody.

The genre's relationship to the real Japanese idol industry — where actual young women perform in similar group structures under conditions that have been criticized for being exploitative — is one of the more uncomfortable questions that the idol anime genre's commercial success does not answer.`,
...
"Eureka Seven" is Bones at its most ambitious: a series that uses the mecha genre's resources — scale, spectacle, the resonance of piloted machines — to tell a story that is primarily about the interior development of its protagonist.`,
  ...
  },
  {
    ...
    content: `"Darling in the FranXX" was co-produced by Studio Trigger and CloverWorks (the A-1 Pictures sub-studio) in 2018, directed by Atsushi Nishigori with character designs by Masayoshi Tanaka. The series follows Hiro, a failed pilot in a post-apocalyptic world where adolescents are trained to pilot mecha called FranXX in male-female pairs, and Zero Two, a mysterious girl with Klaxosaur (alien) blood who is known for consuming her partners. The combination of the elaborate paired-piloting mechanic — loaded with physical and emotional intimacy — and the series' dystopian coming-of-age story generated an intensely engaged viewership for most of its 24-episode run.

The first half of the series is genuinely excellent. The paired-piloting conceit — in which the female partner's emotional state is directly expressed through the mecha's performance, which the male partner must manage while they share an unusual intimacy — generates narrative content that is simultaneously about mecha combat and about the specific awkwardness of adolescent bodies and adolescent relationships. The children of Squad 13, each with a distinct pairing dynamic, are developed with enough individuality that the ensemble functions as a genuine community rather than a set of types. Zero Two's dangerous reputation, her relationship with Hiro, and the mysteries of her background are managed across the first half with enough care to sustain the viewer's investment through the revelations.

The second half's pivot to cosmological stakes — an expanded conflict with the alien Klaxosaur civilization, a reveal about the organization that manages the children, and a final arc that extends the story beyond Earth — was received by much of the audience as abandoning the specific human drama that had generated the series' appeal in favor of genre plot mechanics that the series was not constructed to support. The final episodes' ambitions are clear; the execution was divisive. The ending sacrifices the relationship between Hiro and Zero Two — the series' emotional center — for a resolution whose scale does not match what the preceding episodes had built.
...
The co-production between Trigger and CloverWorks generated speculation about whether the tonal inconsistency of the second half reflected the difficulty of managing two studios' creative cultures across a single production. Both studios have produced excellent work independently; the combination in "FranXX" produced something that was more than the sum of its parts in its first half and less in its second. It remains, for its first half, one of the decade's more interesting mecha anime.`,
  ...
  },
  {
    ...
    category: 'industry',
    excerpt: 'Korean webtoons — vertically scrolling digital comics optimized for smartphone reading — have built a global audience that rivals manga\'s international readership. Solo Leveling\'s anime adaptation in 2024 was the first major demonstration that manhwa could generate the same anime-to-source-material pipeline that manga has used for decades.',
    content: `Korean webtoons — comics published digitally in vertical scrolling format, optimized for smartphone reading — have built a global audience that, by some measures, rivals manga's international readership. The major Korean platforms: LINE Webtoon (launched 2014 internationally), Kakao Page, and Naver Webtoon together host hundreds of thousands of titles and have generated billions in revenue. The format's design choices — no panel layouts, continuous vertical scrolling, color as standard rather than exception — reflect the smartphone as the primary reading device rather than the printed page, and these choices produce a reading experience that is fundamentally different from manga.

The difference is not simply cosmetic. Manga's panel layout — the management of page space across multiple panels, the use of the gutter between panels as narrative space, the relationship between spread layouts and individual moments — is a formal language that took decades to develop and that the best manga uses with sophisticated intentionality. The webtoon's continuous scroll eliminates the page as a unit of meaning, which removes the specific formal possibilities that manga's page-based structure enables while adding different ones: the reveal through scrolling, the use of long vertical sequences for time and scale, the specific pacing that scrolling speed allows.

"Solo Leveling," by Chugong, is the manhwa that most dramatically demonstrated the format's international commercial potential. Originally a web novel, adapted into manhwa illustrated by DUBU (Jang Sung-rak) on KakaoPage from 2018 to 2021, the series follows a weak hunter — the lowest rank in a world where people develop supernatural abilities to fight dungeon monsters — who gains an ability to grow infinitely stronger. The series' fantasy premise, its clean visual presentation, and its core power fantasy were globally accessible in ways that made it the most-read manhwa internationally before its anime adaptation. The 2024 anime adaptation by A-1 Pictures was among the year's most-watched, demonstrating that the manga-to-anime pipeline was replicable for manhwa that had developed sufficient international recognition.
...
The Japanese manga industry's response to the webtoon challenge has been cautious but observable. Major publishers have begun releasing vertical scroll versions of existing manga for digital platforms and have started developing original webtoon-format content. Whether the two formats will develop in parallel, merge, or see one displace the other depends on market forces that are still in motion. What is clear is that the assumption that manga has a natural monopoly on the graphic narrative form in East Asian culture is no longer defensible.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'Tezuka\'s Dororo serialized in 1967 and 1968 about a samurai warrior born without body parts — sold to 48 demons by his father in exchange for power — who must defeat each demon to reclaim his body. The 2019 MAPPA anime proved that the premise had lost none of its moral and emotional force over fifty years.',
    content: `"Dororo" by Osamu Tezuka serialized in Shōnen Sunday from August 1967 to July 1968, producing 4 collected volumes before Tezuka ended it, dissatisfied with reader response. The series follows Hyakkimaru, a samurai warrior who was born without eyes, ears, nose, skin, or limbs — his father, Daigo Kagemitsu, made a pact with 48 demons before his birth, granting each demon a piece of his unborn son's body in exchange for the power to rule his domain. Hyakkimaru has survived through prosthetics and supernatural senses, and travels Japan hunting the demons to reclaim, one by one, the body parts that were taken from him. The orphaned thief Dororo accompanies him.

The premise is among the darkest in Tezuka's catalogue — which is saying something given that Tezuka's adult work includes "Ode to Kirihito" and "MW" — and Tezuka deploys it without the softening that characterized his work for younger audiences. The central irony: each demon Hyakkimaru defeats restores a body part, including eventually his eyes, ears, and the ability to feel pain. The restoration of sensation is not uniformly experienced as good. To have been without pain for your entire life and then to gain the capacity for it is not simply a gift, and the series is interested in this ambiguity without resolving it into consolation.

The original manga's abrupt ending — which Tezuka reportedly ended mid-arc due to poor serialization response — left the premise's implications largely unexplored. Tezuka's own 1969 anime adaptation compressed the story further. The 2019 anime adaptation produced by MAPPA and Tezuka Productions, directed by Kazuhiro Furuhashi, used the premise's full implications to construct a complete 24-episode narrative that many critics considered the definitive realization of the material. The production's visual design — desaturated color palette, specific period detail, the depiction of Hyakkimaru's prosthetics and his restored senses — and its handling of the political backstory (the famine and warfare that made Daigo's pact comprehensible if not forgivable) gave the series a moral weight that the original's truncated run had only gestured at.

The 2019 anime's resolution of the relationship between Hyakkimaru and Daigo, and its treatment of what Hyakkimaru becomes as his body is restored — the question of whether a person who has lived as a weapon can become something else — is handled with more complexity than the premise requires and more honesty than the audience comfortable with simple redemption narratives might prefer.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'Soul Eater serialized in Monthly Shōnen Gangan from 2003 to 2013 and established a visual aesthetic — Halloween gothic, asymmetrical design, a moon that grins — that defined a specific period of shonen aesthetics. Before Fire Force, Atsushi Ōkubo created the most distinctive visual world in early 2000s manga.',
    content: `"Soul Eater" by Atsushi Ōkubo serialized in Monthly Shōnen Gangan from 2003 to 2013, producing 25 collected volumes. The series is set in Death City, Nevada, where the Shinigami (Death) runs the Death Weapon Meister Academy — a school where students called meisters team with human-weapon hybrids (humans who can transform into weapons) to collect the souls of evil beings and prevent the resurrection of the Kishin, a demon god of madness. The premise is unusual enough to sustain a decade of serialization, but the series' most immediately recognizable quality is visual: a Halloween gothic aesthetic — grinning moon, twisted architecture, asymmetrical character design — that established a visual identity strong enough that readers who encountered it as children carry a specific visual memory of what this world looked like.

Ōkubo's design sensibility is the series' primary contribution to manga history. The moon and sun that dominate the series' skies — the moon permanently grinning with visible teeth, the sun sweating and yelling — are not simply background elements but emotional registers that the series uses as shorthand for tonal state. The character designs are deliberately asymmetrical in ways that classical design training would identify as incorrect, and the incorrectness is the point: these are characters who exist in a world that has been deliberately bent away from ordinary visual logic. The architectural designs — the twisting buildings of Death City, the Shinigami's castle — are built from visual excess rather than proportion.
...
The 2008 anime adaptation by Bones covered approximately the first two-thirds of the manga before diverging for an original ending, which was received with mixed responses from manga readers who felt the original ending was inferior to where the manga was heading. Ōkubo's subsequent series "Fire Force" (2015–2022) demonstrated that the visual intelligence of "Soul Eater" was portable across new premises, suggesting that the aesthetic was the creator's rather than the property's.`,
    tags: ['Soul Eater', 'Atsushi Ōkubo', 'Monthly Shōnen Gangan', 'Bones anime', 'gothic manga', 'manga 2000s'],
    entities: ['Atsushi Ōkubo', 'Bones'],
  ...
  },
  {
    ...
    category: 'anime',
    excerpt: 'Hellsing by Kouta Hirano ran from 1997 to 2008 as a deliberately operatic vampire action manga. The Hellsing Ultimate OVA, produced by Madhouse and later Graphinica between 2006 and 2012, is the definitive adaptation — ten episodes that honor the manga\'s scale without apologizing for its excess.',
    content: `"Hellsing" by Kouta Hirano serialized in Young King OURs from 1997 to 2008, producing 10 collected volumes. The series follows the Hellsing Organization — a British secret service tasked with dealing with supernatural threats — and its ultimate weapon, Alucard, an ancient and supremely powerful vampire who serves Integra Hellsing as a loyal instrument of destruction. The premise is the delivery mechanism for a sustained exercise in operatic excess: enormous battles between supernatural factions, extreme violence depicted without restraint, and an aesthetic sensibility that commits fully to its own theatricality. The series is not subtle and does not attempt to be.

The first Hellsing anime, produced by Gonzo in 2001, adapted the manga's early material before diverging into an original story — a decision made necessary by the manga's slow publication pace but that produced an anime widely considered inferior to the source material. The original anime's original villain and its more conventionally structured dramatic arc replaced the manga's escalating factional warfare with a more manageable narrative, losing the specific quality of excess that the manga's later volumes made its defining characteristic.

The Hellsing Ultimate OVA, produced initially by Madhouse (later Graphinica) and released as ten episodes between 2006 and 2012, is the definitive version. The OVA format — longer individual episodes, release at irregular intervals, a budget structure not dependent on broadcast television constraints — permitted the visual ambition that the manga's later material required. The Millennium faction's invasion of London, and the three-way battle between Hellsing, Millennium, and the Vatican that constitutes the series' climax, involves a scale of destruction and a density of faction politics that Gonzo's 13-episode series could not have accommodated.

Alucard is the series' most discussed element. His combat style — allowing himself to be destroyed in elaborate ways before demonstrating that destruction cannot kill him — is a visual approach to invulnerability that is specifically theatrical, designed to be more interesting to watch than simple domination. His relationship with Integra, which is one of loyalty and genuine respect rather than servitude, gives his character a depth that the excess of his combat behavior might otherwise obscure. The series' final volumes, and the OVA's corresponding final episodes, develop this relationship to a conclusion that the series' operatic register manages to make genuinely moving.`,
...
The medium's most adventurous formal achievements — the works that have expanded what anime can do — are disproportionately originals. This is not a coincidence. It reflects the specific freedom that original production enables: the ability to build a work around what animation can do rather than around what needs to be adapted.`,
  ...
  },
  {
    ...
    category: 'anime',
    excerpt: 'Anime opening songs are discussed constantly. Anime ending songs are skipped by most viewers and underappreciated by most discourse. The ending theme\'s function — decompression, emotional processing, transition back to ordinary life — is distinct from the opening\'s, and the best ending songs are specifically designed to do it.',
    content: `Anime opening songs are discussed at length: ranked, analyzed, studied for their visual storytelling, cited as introductions to artists who became significant careers. Anime ending songs are skipped. Most streaming platforms show the percentage of viewers who watch past the credits, and for most anime, ending sequences are skipped by the majority of viewers before the music finishes. The skipping is understandable — endings often air at the point of maximum plot tension, when the viewer wants to advance — and it has produced a received critical neglect of the ending theme as an art form. The neglect is undeserved.

The ending theme's function is distinct from the opening's. The opening announces the anime, establishes its tonal register, and generates energy for what follows. The ending performs a different emotional operation: it provides decompression after the episode's events, a transition space between the story world and the viewer's ordinary life. The best ending songs are specifically designed for this function — they match the emotional state the episode has generated and process it rather than dispelling it, leaving the viewer in a particular condition rather than simply signaling that the episode is over.

"Neon Genesis Evangelion"'s ending, "Fly Me to the Moon" — a different arrangement sung by a different character each episode — used the space to comment on the episode's emotional content while maintaining ironic distance from it, generating a specific form of tonal complexity that the opening did not attempt. "Fullmetal Alchemist: Brotherhood"'s rotating ending songs — "Uso" by SID, "Hologram" by NICO Touches the Walls, "Let It Out" by Miho Fukuhara — each calibrated to the arc they accompanied, demonstrated that ending songs could function as structural components rather than afterthoughts. "Anohana"'s ending "secret base ~Kimi ga Kureta Mono~" extended the episode's grief into the credits in a way that felt continuous with rather than separate from the episode's emotional experience.
...
The viewers who skip endings are missing music and visual design that, in the best cases, constitutes a distinct artistic statement about the work they have just watched. The skip button is understandable. The ending is worth stopping for.`,
  ...
  },
  {
    ...
    category: 'manga',
    excerpt: 'Noragami has been running in Monthly Shōnen Magazine since 2011, following Yato, a minor deity without a shrine who charges 5 yen for odd jobs while dreaming of worship. The series uses Japanese mythology and the spirit world to examine what it means to be forgotten, and whether being remembered is worth what it costs.',
    content: `"Noragami" by Adachitoka serialized in Monthly Shōnen Magazine from 2011 and continues. The series follows Yato, a minor war god without a shrine, who advertises his services with a phone number and charges 5 yen per job — dreaming of the day he will have enough worshippers to build a proper shrine. When high school student Hiyori Iki is hit by a bus while pushing Yato out of the way, her soul becomes loosely attached to her body, enabling her to perceive the spirit world. Yato also recently dismissed his shinki (divine weapon) and must recruit a new one. The series develops from these premises into an increasingly complex examination of Japanese mythology, the relationship between gods and the humans who need them, and the specific cost of existing in a form that depends on being remembered.

The mythology integration is the series' most sustained achievement. Adachitoka researches Japanese folk religion and Shinto practices with visible care, and the mechanisms by which gods exist, accumulate power, and can be erased — all governed by the belief and memory of humans — are developed with internal consistency rather than deployed as convenient plot devices. The shinki system, in which gods empower the souls of the dead as their divine weapons, generates the series' most emotionally complex material: the shinki are dead humans whose identities have been suppressed to serve their gods, and the series is interested in what this suppression costs and what obligations it creates.

Yato's character is the series' most interesting element. He is introduced as comic — the minor god with the crass advertising, the resentment of more prosperous deities — and gradually revealed as someone whose past is darker and whose present circumstances are more precarious than the comedy suggests. His relationship with his father — a god whose existence depends on Yato continuing to accept work as a god of calamity — is the series' primary antagonist dynamic, and it is developed across the series' long run as a genuinely complicated dependency rather than a simple villain-hero opposition.
...
The 2015 anime adaptation by Bones, and its second season "Noragami Aragoto" (2015), were received as faithful and visually accomplished adaptations that demonstrated Bones' ability to realize the series' mythology-based action sequences. The ongoing manga has developed beyond what the anime covered into territory that requires the accumulated investment of the series' full run to yield its complete emotional effect.`,
    tags: ['Noragami', 'Adachitoka', 'Monthly Shōnen Magazine', 'Bones anime', 'Japanese mythology', 'manga ongoing'],
  ...
  },
  {
    ...
    category: 'anime',
    excerpt: 'Wonder Egg Priority aired in 2021 as an anime original by CloverWorks that generated more critical discussion per episode than almost any anime in recent memory — for its visual ambition, its serious engagement with suicide and trauma, and for the way its finale complicated everything the preceding episodes had built.',
    content: `"Wonder Egg Priority" aired as an anime original produced by CloverWorks in Winter 2021, written by Shinji Nojima and directed by Shin Wakabayashi. The series follows Ai Ohto, a girl recovering from the suicide of her best friend, who begins purchasing "Wonder Eggs" from a mysterious vending machine — eggs that, when broken, release a girl who died by suicide and must be protected from monsters in a dreamlike parallel world. Collecting the eggs and protecting the girls might, the series suggests, restore Ai's friend to life. The setup was received as among the most emotionally serious engagements with adolescent mental health, self-harm, and the specific grief of surviving a friend's suicide in recent anime, and the first several episodes were the most-discussed anime of their season.

The visual ambition of the early episodes was the immediate quality that generated attention. The production design of the dream-world sequences — environments derived from the specific circumstances of each dead girl's life, rendered with a visual inventiveness that made each episode visually distinct — demonstrated that CloverWorks had committed significant creative resources to the project. The character animation quality in the combat sequences, and the care in the direction of the conversations between Ai and the girls she protected, communicated a production under creative pressure of a specific kind: the pressure of artists who knew they were working on something ambitious and were trying to be adequate to it.

The series' engagement with its central subject — suicide, bullying, abuse, the specific forms of harm that adolescent girls are subjected to — was more direct than anime typically attempts. Each egg-girl's backstory constituted a specific case study in a different form of harm, and the series' willingness to depict those harms without simplifying them into generic tragedy was the quality that generated the most sustained critical engagement from viewers who found the material resonant.

The finale — including a delayed special episode released in June 2021 that was intended to conclude the series — was received as a significant creative failure by much of the audience that had been most invested. The special episode's compressed handling of plot threads that had been carefully developed across the preceding episodes, and its ending's refusal to provide the emotional resolution the series had seemed to promise, generated debate about whether the failure was narrative (the story was irresolvable) or production (the production timeline made adequate completion impossible). The honest answer is probably both.
